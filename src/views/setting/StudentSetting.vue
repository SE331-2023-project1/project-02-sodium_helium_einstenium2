<template>
    ...
    <div class="md:col-span-6 text-right mt-2">
        ...
        <button
        class="bg-[#1f3edd] hover:bg-[#4857eb] text-white font-bold py-2 px-4 rounded"
        type="submit"
        >Submit</button>
                  </div>
                </div>
