...
<template>
  <div>
    <div v-if="oneStudent">
      ...
      >
        <span class="absolute top-0 left-0 bg-[#1f3edd] rounded-br-lg text-white px-6 py-1.5"
          >Student</span
        >
      ...
      <form @submit.prevent="onSubmit">
        ...
        >
          ...
          <div class="flex items-center justify-between px-3 py-2 border-t">
            <button
              type="submit"
              class="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-[#1f3edd] rounded-lg focus:ring-4 focus:ring-[#4857eb]"
            >
              Post comment
            </button>
          </div>
