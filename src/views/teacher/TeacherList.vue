  ...
  <main class="flex flex-col items-center justify-center">
    ...
    <div v-if="totalPages != 0" class="pagination flex items-center -space-x-px h-10 mt-4">
      ...
      <span v-for="pageNumber in totalPages" :key="pageNumber">
        ...
        <span
          v-else
          class="z-10 flex items-center justify-center px-4 h-10 leading-tight text-[#1f3edd] border border-[#4857eb] bg-[#d6f5e2] hover:bg-[#4857eb] hover:text-[#1f3edd] cursor-pointer"
          >{{ pageNumber }}</span
        >
      </span>
      <RouterLink
